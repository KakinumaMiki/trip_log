Place.seed(:id,
           { prefecture_id: 1, category_id: 1, name: '登別温泉', address: '北海道登別市', gone: true, memo: 'memo1' },
           { prefecture_id: 1, category_id: 4, name: '札幌時計台', address: '北海道札幌市', gone: false, memo: 'memo2' },
           { prefecture_id: 1, category_id: 4, name: '旭山動物園', address: '北海道旭川市', gone: true, memo: 'memo3' },
